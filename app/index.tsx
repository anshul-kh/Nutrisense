...
import Fink from "../assets/share.png";
      ...
      <View style={tw`flex-1 justify-center mt-10  w-full items-center`}>
        ...
        <View style={tw`flex flex-col mt-4 justify-center items-center `}>
          <View style={tw`flex flex-col mr-40 justify-center items-center`}>
            ...
            <Text style={tw`text-blue-600 ml-20 text-5xl`}>Health</Text>
          </View>
          <View style={tw`flex flex-col ml-32 justify-center items-center`}>
            <Text style={tw`text-white text-5xl mr-20 font-semibold`}>
              Your
            </Text>
            <Text style={tw`text-blue-600 text-5xl ml-20 `}>Scan</Text>
          </View>
        </View>
        <View
          style={tw`w-10/12 mt-14 rounded-3xl flex items-center justify-center flex-row bg-blue-600 h-16`}
        >
          <Link href={"/home"}>
            <View style={tw`flex flex-row justify-center gap-36 items-center `}>
              <Text style={tw` text-3xl text-white`}>Explore</Text>
              <Image source={Fink} style={tw`w-8 h-9`} />
            </View>
          </Link>
        </View>
      </View>
